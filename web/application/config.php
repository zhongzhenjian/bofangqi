...
return [
    ...
    'fastadmin'              => [
        ...
        //'user_register_captcha' => 'text',     原  会员中心注册验证码
    ...
    'host'=>'111'    //此处为社区图片、头像等地址域名 必填！修改成你正在使用的后台地址，不然APP和WAP网页图片不显示 154.31.62.15
    //'host'=>'https://ikulm.cn/'    //此处为社区图片、头像等地址域名 必填！修改成你正在使用的后台地址，不然APP和WAP网页图片不显示 154.31.62.15
    //'host'=>'https://hanuu.cn/'    //此处为社区图片、头像等地址域名 必填！修改成你正在使用的后台地址，不然APP和WAP网页图片不显示 154.31.62.15
];
