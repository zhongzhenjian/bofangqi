...
function suiji(){
    $all = \app\admin\model\Publisher::all()->toArray();
    $all = $all[array_rand($all)];
    return $all;
}
/**
 * 短信发送
...
function send_sms($to, $model, $code)
{
    ...
    $accessKeyId = 'LTAI4GJY7GPESaNUGen6CozH';
    $accessKeySecret = 'gcbohfbIQNRKSf9WmaIp9SXdHpyrJa';
    $templateParam = $code;
    //短信签名
    $signName = '聚色';
    //短信模板ID
    switch ($model) {
        case 1:
            $templateCode = 'SMS_200178476'; // 注册登录短信验证码模板
            break;
        case 2:
